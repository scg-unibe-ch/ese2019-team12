...
export class ExplorePage implements OnInit {
    ...
    services = [
        ...
        new Service(3, 3, 'Jim\'s clean up crew', 'Cleaning for your \"Party\" if you need any \"cleaning\" call Jim.', 300, ['clean', 'murder']),
        new Service(4, 4, 'Bulletti\'s Bulletten', 'Die besten Bulletten in der Stadt. Kommt und probiert Lucas\' saftige Bulletten.', 5, ['buns','bulletten', 'juicy']),
        new Service(5, 5, 'Yael\'s mad DJ-Set', 'DJ Yael an den Turntables. Beste DJ-Sets direkt hier.', 100, ['party', 'disco', 'mad','sick']),
        new Service(6, 2, 'Lino\'s Club', 'Coolest venue in town. We even have a shoecleaner.', 2000, ['fancy','place to be']),
        new Service(7, 3, 'Domi\'s Shoecleaners', 'Cleaning shoes is what I do.', 30, ['clean', 'shoes','spotless']),
        new Service(8, 6, 'Gelateria di Berna', 'Gelateria di Berna kommt bei dir vorbei. Geniesse alle unsere Sorten bequem von deiner Veranda aus.', 5, ['ice cream','tasty','Calories']),
        new Service(9, 4, 'Pitteria', 'Leckere Pittas in Bern.', 18, ['pitta', 'hummus','food']),
        new Service(10, 5, 'Baccardi Bar Services', 'Verschiedenste Barkeeper werden entzücken mit Mixkünsten der Extraklasse.', 2500, ['Cocktails','Fun','drinking','beer']),
        new Service(11, 2, 'Buffalow Wings', 'Get the spiciest Chicken-Wings at your party.', 150, ['spicy', 'chicken-wings','food']),
        new Service(12, 3, 'DJ Domi und die Funky Five', 'DJ Domi und die Funky Five treten bei euch zu Hause auf. Funky beats von DJ Domi mit harmonischen sounds der Funky Five.', 600, ['Funky','DJ', 'party', 'Musik']),
        new Service(13, 4, 'OpenCinemaCrew', 'Ihr privates Kino Erlebnis. Egal ob für Kindergeburtstage oder Firmenanlässe, wir zeigen Herr der Ringe überall.', 1000, ['Kino', 'cinema','LOTR','Hobbit']),
        new Service(14, 5, 'Lino\'s Taxi Service', 'Zu lange getanzt? Zu viel getrunken? Lass dich entspannt und gemütlich nach Hause chaufieren von Lino\'s Chauffeuren.', 20, ['safe', 'home','taxi']),
        new Service(15, 3, 'Guacamole Guapos', 'Ven a buscar la mejor guacamole en la ciudad. Guacamole por todo el mundo.', 8, ['guacamole', 'spicy','verde']),
